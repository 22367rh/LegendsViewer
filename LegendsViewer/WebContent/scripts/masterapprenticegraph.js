document.addEventListener('DOMContentLoaded', function () {
    ...
    var cy = cytoscape({
        container: document.getElementById('masterapprenticegraph'),
        ...
        elements: {
            nodes: window.masterapprenticegraph_nodes,
            edges: window.masterapprenticegraph_edges
        },
